...
c.colors.hints.bg = bright_green #'rgba(250, 191, 47, 200)'  # bright_yellow
...
c.colors.statusbar.insert.bg = dark_blue
...
c.colors.statusbar.private.bg = dark_purple
...
c.colors.tabs.indicator.stop = dark_green
...
c.colors.tabs.selected.odd.bg = bright_green

# Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = c.colors.tabs.selected.odd.fg

# Background color of selected even tabs.
c.colors.tabs.selected.even.bg = bright_green
...
c.colors.tabs.pinned.selected.even.bg = bright_orange
